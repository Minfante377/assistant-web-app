...
class ScheduleEventViewTest(TestCase):
    """
    This class implements all the tests for the schedule_event view.
    """
    ...
    def test_schedule_event(self):
        """
        This test schedules an event from the owner's calendar.
        """
        self.client.force_login(self.user_owner)
        body = {
            'event_info': '{}|{}|{}'
        ...
        self.client.post(reverse('schedule_event'),
                         body,
                         content_type='application/json')
        self.event.refresh_from_db()
        self.assertEqual(self.event.free, False, msg='Event was not scheduled')
        self.assertIsNotNone(self.event.client, msg='Event was not scheduled')
